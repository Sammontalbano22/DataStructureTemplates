...
Assignmnet: Project 1 - The Game of Snake
Collaborators: Garret Veyna
...
import dudraw # This game utalizes the University of Denvers version of Pygame called DUdraw. To run you must install DUDRAW.
